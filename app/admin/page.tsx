    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-700">Lecturers</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-700">News & Events</h2>
              <p className="text-3xl font-bold text-gray-900">0</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            <div className="bg-orange-500 rounded-full p-3 text-white mr-4">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600">
          This is a simple admin dashboard for managing your website content. Use the sidebar to navigate to different sections.
        </p>
      </div>
    </div>
  );
